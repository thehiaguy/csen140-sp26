...
doc.add_paragraph(
    ...
    'ensembling through trial and error. Final leaderboard score: 0.9587 (11-model, '
    'score-level + T=1.5). Local F1: 0.9245.',
    style='Intense Quote'
)
...
leaderboard = [
    ...
    ('0.9587', 'FINAL BEST — 11-model ensemble (+ M9 LSI-TFIDF, M10 LSI-BM25, M11 PRF) '
               'with score-level soft voting and T=1.5 temperature. Local: 0.9245. '
               'Confirms that M9/M10/M11 and score-level ensembling transfer from '
               'validation to held-out test set — no overfitting.'),
]
